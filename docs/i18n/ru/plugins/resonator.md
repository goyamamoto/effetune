...
Улучшенная модель рупора, использующая Bessel-функцию для отражения устья и частотно-зависимое отражение горла для более плавного резонанса.
...
- **Отражение устья на основе Bessel**: Моделирование радиационного импеданса через Bessel-функции для более точного частотно-зависимого отражения
...
- **Более плавная частотная характеристика**: Отражение устья на основе Bessel создает более естественное затухание резонансного пика
...
- **Horn Resonator Plus**: Выбирайте, когда требуется более высокое качество и более естественные акустические характеристики рупора (примерно +5% нагрузки на CPU)
